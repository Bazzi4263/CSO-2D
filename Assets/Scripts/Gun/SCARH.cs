...
public class SCARH : Gun
{
    public static string s_gunName = "SCAR-H";
    public static int s_gunDamageMin = 41;
    public static int s_gunDamageMax = 55;
    public static int s_criticalDamage = 198;
    public static float s_fireRate = 0.1f;
    public static float s_spread = 3.8f;
    public static float s_Zoomspread = 2.7f;
    public static float s_reloadTime = 2f;
    public static float s_decelerationSpeed = 0.88f;
    public static int s_maxAmmo = 240;
    public static int s_ammo = 20;
    public static int s_currentAmmo = 20;
    public static float s_recoilAmount = 2.7f;
    ...
    public void Zoom()
    {
        if (PV.IsMine)
        {
            if (Input.GetMouseButtonDown(1) && !isZoom)
            {
                ...
                fov.GetComponent<FieldOfView>().viewDistance = 40;
                fov.GetComponent<FieldOfView>().rayCount = 300;
                GameObject.FindWithTag("CMCamera").GetComponent<CinemachineVirtualCamera>().m_Lens.OrthographicSize = 11;
